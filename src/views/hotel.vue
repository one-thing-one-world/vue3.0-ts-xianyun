        ...
        <div class="peobox d-f a-l">
          ...
          <div v-if="flag1 == true" class="chosebox">
            <div class="chosebox1">
              ...
              <div class="chbtbox">
                <a-button type="primary" size="mini" @click="choseend"
                  >确定</a-button
                >
              </div>
            </div>
          ...
          <div class="d-f">
            ...
            <div v-if="flag === false">
              ...
              <div @click="openhigeht" class="fs14">
                <img class="imgss" src="../../public/image/open.png" alt />
                等25个区域
              </div>
            </div>
            <div v-if="flag === true">
              ...
              <div @click="opendown" class="fs14">
                <img class="imgss" src="../../public/image/close.png" alt />
                等25个区域
              </div>
            </div>
          </div>
          <div class="d-f m-t-10">
            <div class="lbposition1">
              ...
              <a-tooltip placement="topLeft">
                ...
                <span class="sloatas">?</span> </a-tooltip
              >：
            </div>
            <div class="d-f ratebox">
              <div class="m-r-10">
                <a-tooltip placement="bottom">
                  <template v-slot:title>
                    <span
                      >等级评定是针对房价，设施和服务等各方面水平的综合评估</span
                    >
                  </template>
                  <div>
                    <img
                      class="imgss"
                      src="../../public/image/huangguan.png"
                      alt
                    />
                    <img
                      class="imgss"
            ...
            <div class="hbmsgbox">
              ...
              <div class="hbmsgbox-fs2">
                ...
                <span v-if="item.hotellevel">
                  <a-rate
                    v-model:value="item.hotellevel.level"
                    disabled
                    allow-half
                  ></a-rate>
                </span>
              ...
              <div class="d-f m-b-15">
                ...
                <div class="hbmsgfont m-l-10">
                  {{ item.very_bad_remarks + item.very_good_remarks }}条评论
                </div>
                <div></div>
              </div>
              <div class="hbmsgfont">
